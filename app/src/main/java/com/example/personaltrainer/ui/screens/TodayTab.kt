...
import com.example.personaltrainer.shared.SharedWorkoutUtils
import com.example.personaltrainer.shared.SharedDateUtils
...
fun TodayTab(
    ...
    val todays = remember(serverWorkouts, todayMask) {
        serverWorkouts
            .filter { workout ->
                SharedWorkoutUtils.hasWorkoutOnDay(
    ...
    fun loadServerNotifications() {
        scope.launch {
            ...
            runCatching {
                ...
                LogTest.notificationLoaded(sorted.size)
...
private fun formatDuration(sec: Long): String {
    return SharedDateUtils.formatDurationShort(sec)
}
